...
namespace XamarinForms3RestApiApp
{
	public partial class MainPage : ContentPage
	{
        ...
        private const string Url = "https://elephant-api.herokuapp.com/elephants";
        ...
        private async void OnUpdate(object sender, EventArgs e)
        {
           ...
           // post.Title += " [updated]"; //Appending an [updated] string to the current value of the Title property
            ...
            string myURL= "https://elephant-api.herokuapp.com/elephants";
            // Obtenir les contenus du web|API
            var content = await _client.GetStringAsync(myURL);
            set_post_data(content);
            await DisplayAlert("Sauvegarde locale", "Sauvegarde reussie", "OK");
        ...
        public static void set_post_data(string json)
        {
                ...
                //Assigner la propriete des donnees
        ...
        private async void OnDelete(object sender, EventArgs e)
        {
            try {
                ...
                await DisplayAlert("Json", get_post_data(), "Ok");
            }
            catch (Exception )
            {
                await DisplayAlert("Locale", "Aucun API n'a été stocké localement", "OK");
            }
        }
